...
import { FilretUserComponent } from './component/filret-user/filret-user.component';
...
@NgModule({
  declarations: [
    ...
    SineInComponent,
    AllTripComponent,
    AllTypeOfTripComponent,
    TripByIdTypeComponent,
    AllTripPerUsertComponent,
    HomeComponent,
  ...
  imports: [
    ...
    RippleModule,
    StyleClassModule,
    // RouterModule.forRoot([{ path: '', component: ColorPickerBasicDemo }])],
    //   declarations: [ ColorPickerBasicDemo ],
    //   bootstrap: [ ColorPickerBasicDemo ],
    //   providers: [  ]
